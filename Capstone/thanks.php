...
<html lang="en">
  ...
  <body>
    ...
    <div id="thanks-section">
      <h1 class="section-title">THANK <span> YOU</span></h1>
      <div class="thanks-title">
      <p class="section-title">You are successfully registered!</p>
    </div>
    </div>
    <!-- Footer -->
    <section id="footer" class="thanks-page">
